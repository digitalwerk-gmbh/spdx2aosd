...
describe("Spdx Spec converter Tests", () => {
    test('Test convertSpdxSpec to be defined', async () => {
        expect(convertSpdxSpec).toBeDefined();
    });
    test('Test convertSpdxSpec function works as expected', async () => {
        const response = await convertSpdxSpec('test_group_spec_spdx.json');
